  ...
  return (
    ...
    >
      ...
      <div className="max-w-2xl">
        <Skeleton className="h-9 w-72 rounded-lg sm:h-10 sm:w-96" />
        <Skeleton className="mt-3 h-5 w-64 rounded-md sm:w-80" />
      </div>
      ...
      <div className="mt-3 flex max-w-3xl items-center justify-between gap-4">
        ...
        <Skeleton className="hidden h-4 w-48 rounded sm:block" />
      </div>
